...
import FilterForm from '../../src/containers/filters/Form';

import {SPINNER_COLORS} from '../../src/utils/enums';
import GeneralApi from '../../src/utils/generalApi';
import {IFilter} from '../../src/interfaces/product';
...
export default function FiltersPage() {
  ...
  const {isFetching, data} = useQuery(['filters'], () => generalApi.get('/filters/list'), {
      ...
      <div className="flex flex-1 items-stretch overflow-hidden">
        <main className="flex-1 overflow-y-auto">
          <div className="mx-auto max-w-7xl px-4 pt-8 sm:px-6 lg:px-8">
            <div className="flex">
              <h1 className="flex-1 text-2xl font-bold text-gray-900">Filtros</h1>
            ...
            <section className="mt-8 pb-16" aria-labelledby="gallery-heading">
              ...
              >
                {data?.data?.map((filter: IFilter) => (
                  <li key={filter._id} className="relative">
